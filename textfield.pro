...
UBUNTU_TRANSLATION_DOMAIN="textfield.liu-xiao-guo"
...
aptest.commands = bash $$PWD/textfieldinput/tests/autopilot/run
aptest.depends  = sub-textfieldinput

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/textfieldinput/tests/unit 
unittest.depends  = sub-textfieldinput
